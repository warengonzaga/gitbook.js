...
This project and everyone participating in it is governed by the GitBookJS [Code of Conduct](https://github.com/warengonzaga/gitbook.js/blob/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@warengonzaga.com>.
...
Answering a question in [Discussions](https://github.com/warengonzaga/gitbook.js/discussions) is one of the easiest ways to start contributing.
